		...
		do {
			...
			try {
				...
				case 1:
					...
					do {
						nombre = JOptionPane.showInputDialog("Nombre del Comprador:");
						v = new Validar(nombre) ;
						
					} while (!v.validarLetras(v));
					
                   do {
                	   cedula= JOptionPane.showInputDialog(null, "Cedula del Comprador");
			...
			while ((("S".equals(resp)) ||  ("s".equals(resp)))  &&  (i < maxProd));
			    do {
			    	cad = JOptionPane.showInputDialog(null,"Introduzca el ");
			    	v = new Validar(cad);
			    	if (v.validarNumeros(v))   {
			    ...
			    do {
			    	descrip = JOptionPane.showInputDialog(null,"Introduzca la Descripcion del producto:");
